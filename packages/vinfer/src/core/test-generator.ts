/**
 * Generates vitest type equality tests for vinfer.
 *
 * This module generates test files that verify vinfer-generated types
 * match v.InferInput<typeof Schema> and v.InferOutput<typeof Schema>.
 */
...
export class TestGenerator {
  ...
  private generateHeader(): string {
    return `// This file is auto-generated by vinfer --generate-tests
...
${tests}
  ...
  private generateSchemaTests(prefix: string, schema: TestSchemaInfo): string {
    ...
    return `    it("${schema.schemaName} input matches v.InferInput", () => {
      expectTypeOf<${prefixedInput}>().toEqualTypeOf<v.InferInput<typeof ${prefixedSchema}>>();
    });

    it("${schema.schemaName} output matches v.InferOutput", () => {
      expectTypeOf<${prefixedOutput}>().toEqualTypeOf<v.InferOutput<typeof ${prefixedSchema}>>();
    });`;
  }
}
