...
import { zinferMiniErrorMessages } from "./core/errors.js";

export interface CLIOptions extends CLIOptionsBase {
  brandStrategy?: "zod-import" | "local-symbol";
}

const bindings: CliBindings<ZinferMiniConfig, CLIOptions> = {
  toolName: "zinfer-mini",
  errorMessages: zinferMiniErrorMessages,

  createExtractor(tsconfigPath) {
    return new ZodMiniTypeExtractor(tsconfigPath);
  },
